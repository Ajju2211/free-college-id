    ...
    return (
        <div>
            <div style={{ background: "rgb(23 22 22)", position: "relative", width: "100%", bottom: "0" }}>
                ...
                <p class="powered" style={{ textAlign: "center",flexWrap: "wrap" ,margin: "0", color: "white", fontWeight: "300", width: "100%", background: "#434343", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <h6 style={{width: "fit-content", whiteSpace: "nowrap"}}>Support us if you like this😄</h6>
                    &nbsp;
                    <a href="https://www.buymeacoffee.com/azharuddin">
                    <img style={{height:"32px", margin:"3px 0 3px 0"}} src="https://img.buymeacoffee.com/button-api/?text=Buy me a coffee&emoji=&slug=azharuddin&button_colour=462a2a&font_colour=ffffff&font_family=Cookie&outline_colour=ffffff&coffee_colour=FFDD00" />
                    </a>
                </p>  
            </div>
        </div>
