    ...
    return (
        <div id="footer">
            <div style={{ background: "rgb(23 22 22)", position: "relative", width: "100%", bottom: "0" }}>
                ...
                <p class="powered" style={{ textAlign: "center",flexWrap: "wrap" ,margin: "0", color: "white", fontWeight: "300", width: "100%", display: "flex", alignItems: "center", justifyContent: "center" }}>
